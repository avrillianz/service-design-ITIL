                ...
                <div class="col-md-8 col-sm-7 col-xs-12">
                    <div class="h-left clearfix">
                        ...
                        <ol class="breadcrumb breadcrumb-col-pink p-l-0">
                            ...
                            <li class="active">Kontrol Objektif IT Infrastructure Library</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                         <h2> DATA KONTROL OBJEKTIF IT INFRASTRUCTURE LIBRARY </h2>  
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            $no = 1; 
                             ...
                             <tr>    
                                    ...
                                    <td><a href="<?php echo base_url('index.php/itil/view_itil_detail'); ?>"><button type="button" class="btn btn-raised bg-red  waves-effect">DETAILS <i class="material-icons">loyalty</i></button></td>
                                </tr>  
                            <?php } ?>               
                            </tbody>
                        </table>
