        ...
        <div class="row">
            <div class="col-md-8 col-sm-7 col-xs-12">
                <div class="h-left clearfix">
                    <h2> Kuesioner </h2>
                    <small>Create <a href="https://datatables.net/" target="_blank">Data Kuesioner</a></small>
                    <ol class="breadcrumb breadcrumb-col-pink p-l-0">
                        <li><a href="javascript:void(0);">Dashboard</a></li>
                        <li class="active">Kuesioner</li>
                        <li class="active">Create Kuesioner</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">        
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2> FORM CREATE KUESIONER </h2>
                    </div>
                    <div class="body">
                        <form action="<?php echo base_url('index.php/kuesioner/add_kuesioner'); ?>" method="post">
                            <label for="id_kuesioner">ID Kuesioner</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="id_kuesioner" class="form-control">
                                </div>
                            </div>
                            <label for="kuesioner">Pernyataan</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="kuesioner" class="form-control">
                                </div>
                            </div>
                            <label for="control">Kontrol Objektif</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <select class="form-control show-tick" name="id_co">
                                     <?php foreach ($control as $row) { ?>
                                <option  value="<?php echo $row->id_co; ?>"><?php echo $row->id_co; ?> - <?php echo $row->control; ?></option>
                            <?php } ?>    
                                </select>
                                </div>
                            </div>
                            <br>
                            <button type="submit" class="btn btn-raised btn-primary waves-effect" value="submit" onclick="create()">SIMPAN</button>
                            <a href="<?php echo base_url('index.php/kuesioner'); ?>"><button class="btn btn-raised btn-warning waves-effect" type="button">KEMBALI</button>
                        </form>
                    </div>
                </div>
            </div>
