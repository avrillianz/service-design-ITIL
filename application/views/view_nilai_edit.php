        ...
        <div class="row">
            <div class="col-md-8 col-sm-7 col-xs-12">
                <div class="h-left clearfix">
                    <h2> NILAI YANG DIHARAPKAN </h2>
                    <small>Create <a href="https://datatables.net/" target="_blank">Data Nilai</a></small>
                    <ol class="breadcrumb breadcrumb-col-pink p-l-0">
                        <li><a href="javascript:void(0);">Dashboard</a></li>
                        <li class="active">Nilai</li>
                        <li class="active">Create Nilai</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form action="<?php echo base_url('index.php/nilai/edit_nilai/'.$datas[0]['id_nilai']); ?>" method="post">ID Nilai</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="id_co" class="form-control" value="<?php echo $datas[0]['id_nilai']; ?>" disabled>
                                </div>
                            </div>
                            <label for="control">Nilai Yang Diharapkan</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="control" class="form-control" value="<?php echo $datas[0]['id_maturity']; ?>" disabled>
                                </div>
                            </div>
                            <label for="area">Periode</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="periode" class="form-control" value="<?php echo $datas[0]['id_periode']; ?>" disabled>
                                </div>
                            </div>
                            <label for="area">Keterangan</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="keterangan" class="form-control" value="<?php echo $datas[0]['keterangan']; ?>">
                                </div>
                            </div>
                            <br>
                            <button type="submit" class="btn btn-raised btn-primary waves-effect" value="update" onclick="update()">Update</button>
                            <a href="<?php echo base_url('index.php/nilai'); ?>"><button class="btn btn-raised btn-warning waves-effect" type="button">KEMBALI</button>
                            </form>
                        </div>
                    </div>
                </div>
