        ...
        <div class="row">
            <div class="col-md-8 col-sm-7 col-xs-12">
                <div class="h-left clearfix">
                    <h2> Maturity </h2>
                    <small>Create <a href="https://datatables.net/" target="_blank">Data Maturity</a></small>
                    <ol class="breadcrumb breadcrumb-col-pink p-l-0">
                        <li><a href="javascript:void(0);">Dashboard</a></li>
                        <li class="active">Maturity</li>
                        <li class="active">Create Maturity</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>Form Create Maturity</h2>
                    </div>
                    <div class="body">
                        <form id="form_validation" method="post" action="<?php echo base_url('index.php/maturity/add_maturity'); ?>">
