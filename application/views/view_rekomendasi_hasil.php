    ...
    <div class="row">
        <div class="col-md-8 col-sm-7 col-xs-12">
            <div class="h-left clearfix">
                ...
                <small>Melihat Data Hasil Rekomendasi</small>
                <ol class="breadcrumb breadcrumb-col-pink p-l-0">
                    <li><a href="javascript:void(0);">Dashboard</a></li>
                    <li class="active">Hasil Rekomendasi</li>
                </ol>
            </div>
        </div>	
    </div>
               ...
               <div class="body table-responsive">
                ...
                <tbody>
                   ...
                   <tr>    
                    ...
                    <td><a href="<?php echo base_url('index.php/rekomendasi/view_detail_rekomendasi/'.$row->id_periode); ?>"><button type="button" class="btn btn-raised bg-red  waves-effect"><?php echo $row->periode_awal ?> - <?php echo $row->periode_akhir ?> <i class="material-icons">loyalty</i></button></td>
                </tr>  
                <?php } ?>               
            </tbody>
        </table>
