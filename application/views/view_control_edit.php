        ...
        <div class="row">
            <div class="col-md-8 col-sm-7 col-xs-12">
                <div class="h-left clearfix">
                    ...
                    <small>Edit <a href="https://datatables.net/" target="_blank">Data Kontrol Objektif</a></small>
                    <ol class="breadcrumb breadcrumb-col-pink p-l-0">
                        <li><a href="javascript:void(0);">Dashboard</a></li>
                        <li class="active">Kontrol Objektif</li>
                        <li class="active">Edit Kontrol Objektif</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">        
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2> FORM EDIT KONTROL OBJEKTIF </h2>
                    </div>
                    <div class="body">
                        <form action="<?php echo base_url('index.php/control/edit_control/'.$datas[0]['id_co']); ?>" method="post">
                            <label for="id_co">ID Kontrol</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="id_co" class="form-control" value="<?php echo $datas[0]['id_co']; ?>" readonly>
                                </div>
                            </div>
                            <label for="control">Kontrol Objektif</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="control" class="form-control" value="<?php echo $datas[0]['control']; ?>">
                                </div>
                            </div>
                            <label for="area">Area</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="area" class="form-control" value="<?php echo $datas[0]['area']; ?>">
                                </div>
                            </div>
                            <label for="area">Keterangan</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="ket_control" class="form-control" value="<?php echo $datas[0]['ket_control']; ?>">
                                </div>
                            </div>
                            <br>
