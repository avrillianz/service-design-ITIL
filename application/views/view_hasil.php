               ...
               <div class="body table-responsive">
                ...
                <tbody>
                   ...
                   <tr>    
                    ...
                    <td><a href="<?php echo base_url('index.php/hasil/view_hasil_final/'.$row->id_periode); ?>"><button type="button" class="btn btn-raised bg-red  waves-effect"><?php echo $row->periode_awal ?> - <?php echo $row->periode_akhir ?> <i class="material-icons">loyalty</i></button></td>
                </tr>  
                <?php } ?>               
            </tbody>
        </table>
