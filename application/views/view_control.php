        ...
        <div class="row">
            <div class="col-md-8 col-sm-7 col-xs-12">
                <div class="h-left clearfix">
                    ...
                    <small>Mengelola <a href="https://datatables.net/" target="_blank">Data Kontrol Objektif</a></small>
                    <ol class="breadcrumb breadcrumb-col-pink p-l-0">
                        <li><a href="javascript:void(0);">Dashboard</a></li>
                        <li class="active">Kontrol Objectif</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2> DATA KONTROL OBJEKTIF </h2>
                        
                    </div>
                    <div class="body" ><a href="<?php echo base_url()."index.php/control/form_add_control"; ?>" ><button type="button" class="btn btn-raised bg-blue waves-effect">Data Baru <i class="material-icons">library_add</i></button></a>
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>    
                                    ...
                                    <td><?php echo $row->ket_control ?></td>
                                    <td><a href="<?php echo base_url('index.php/control/form_edit_control/'.$row->id_co); ?>"><button type="button" class="btn btn-raised bg-orange btn-block btn-xs waves-effect">EDIT <i class="material-icons">edit</i></button></a></td>
                                    <td><?php echo '<button onclick="hapus(\'Anda Yakin ingin menghapus data ini ?\', \' '.base_url('index.php/control/delete_control/'.$row->id_co).'/control\')" class="btn btn-raised bg-red btn-block btn-xs waves-effect" type="button">DELETE <i class="material-icons">delete_forever</i></button>'; ?>
                                    </td>
                                </tr>   
                                <?php } ?>                        
                            </tbody>
