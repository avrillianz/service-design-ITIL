        ...
        <div class="row">
            <div class="col-md-8 col-sm-7 col-xs-12">
                <div class="h-left clearfix">
                    <h2> MATURITY </h2>
                    <small>Edit <a href="https://datatables.net/" target="_blank">Data Maturity</a></small>
                    <ol class="breadcrumb breadcrumb-col-pink p-l-0">
                        <li><a href="javascript:void(0);">Dashboard</a></li>
                        <li class="active">MATURITY</li>
                        <li class="active">Edit Maturity</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">        
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2> FORM EDIT MATURITY </h2>
                    </div>
                    <div class="body">
                        <form action="<?php echo base_url('index.php/maturity/edit_maturity/'.$datas[0]['id_maturity']); ?>" method="post">
                            <label for="level">Level</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="level" class="form-control" value="<?php echo $datas[0]['level']; ?>" readonly>
                                </div>
                            </div>
                            <label for="maturity">Maturity</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="maturity" class="form-control" value="<?php echo $datas[0]['maturity']; ?>">
                                </div>
                            </div>
                            <label for="keterengan">Keterangan</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="ket" class="form-control" value="<?php echo $datas[0]['ket']; ?>">
                                </div>
                            </div>
                            <br>
                            <button type="submit" class="btn btn-raised btn-primary waves-effect" value="update" onclick="update()">Update</button>
                            <a href="<?php echo base_url('index.php/maturity'); ?>"><button class="btn btn-raised btn-warning waves-effect" type="button">KEMBALI</button>
                            </form>
                        </div>
                    </div>
                </div>
