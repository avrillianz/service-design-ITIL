        ...
        <div class="row">
            <div class="col-md-8 col-sm-7 col-xs-12">
                <div class="h-left clearfix">
                    <h2> KUESIONER </h2>
                    <small>Edit <a href="https://datatables.net/" target="_blank">Data Kuesioner</a></small>
    ...
    <div class="container-fluid">        
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2> FORM EDIT KUESIONER </h2>
                    </div>
                    <div class="body">
                        <form action="<?php echo base_url('index.php/kuesioner/edit_kuesioner/'.$datas[0]['id_kuesioner']); ?>" method="post">
                            <label for="id_kuesioner">ID Kuesioner</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="id_kuesioner" class="form-control" value="<?php echo $datas[0]['id_kuesioner']; ?>" disabled>
                                </div>
                            </div>
                            <label for="kuesioner">Pernyataan</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="kuesioner" class="form-control" value="<?php echo $datas[0]['kuesioner']; ?>">
                                </div>
                            </div>
                            <label for="kuesioner">Kontrol Objektif</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="id_co" class="form-control" value="<?php echo $datas[0]['id_co']; ?> - <?php echo $datas[0]['control']; ?>" disabled>
                                </div>
                            </div>
