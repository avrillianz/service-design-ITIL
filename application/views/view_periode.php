        ...
        <div class="row">
            <div class="col-md-8 col-sm-7 col-xs-12">
                <div class="h-left clearfix">
                    <h2> PERIODE </h2>
                    <small>Mengelola <a href="https://datatables.net/" target="_blank">Data Periode</a></small>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body" ><a href="<?php echo base_url()."index.php/periode/form_add_periode"; ?>" ><button type="button" class="btn btn-raised bg-blue waves-effect">Data Baru <i class="material-icons">library_add</i></button></a>
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>    
                                    ...
                                    <td><?php echo $row->periode_awal ?> s/d <?php echo $row->periode_akhir ?></td>
                                    <td><a href="<?php echo base_url('index.php/periode/form_edit_periode/'.$row->id_periode); ?>"><button type="button" class="btn btn-raised bg-orange btn-block btn-xs waves-effect">EDIT <i class="material-icons">edit</i></button></a></td>
                                    <td><?php echo '<button onclick="hapus(\'Anda Yakin ingin menghapus data ini ?\', \' '.base_url('index.php/periode/delete_periode/'.$row->id_periode).'/periode\')" class="btn btn-raised bg-red btn-block btn-xs waves-effect" type="button">DELETE <i class="material-icons">delete_forever</i></button>'; ?>
                                    </td>
                                </tr>   
                                <?php } ?>                        
                            </tbody>
