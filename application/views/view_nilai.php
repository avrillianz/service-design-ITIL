        ...
        <div class="row">
            <div class="col-md-8 col-sm-7 col-xs-12">
                <div class="h-left clearfix">
                    ...
                    <small>Mengelola <a href="https://datatables.net/" target="_blank">Data Nilai</a></small>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body" >                   
                    <a href="<?php echo base_url()."index.php/nilai/form_add_nilai"; ?>" ><button type="button" class="btn btn-raised bg-blue waves-effect">Data Baru <i class="material-icons">library_add</i></button></a>
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            <thead>
                                <tr>
                                    <th>Nomor</th>
                                    <th>ID Nilai</th>
                                    <th>Nilai Yang Diharapkan</th>
                                    <th>Periode</th>
                                    <th>Keterangan</th>
                                    <th>Action</th>
                                </tr>
                            ...
                            <tbody>
                                ...
                                <tr>    
                                    ...
                                    <td><a href="<?php echo base_url('index.php/nilai/form_edit_nilai/'.$row->id_nilai); ?>"><button type="button" class="btn btn-raised bg-orange waves-effect">EDIT <i class="material-icons">edit</i></button></a></td>
                                </tr>   
                                <?php } ?>                        
                            </tbody>
                        </table>
