        ...
        <div class="row">
            <div class="col-md-8 col-sm-7 col-xs-12">
                <div class="h-left clearfix">
                    <h2> Periode </h2>
                    <small>Create <a href="https://datatables.net/" target="_blank">Data Periode</a></small>
                    <ol class="breadcrumb breadcrumb-col-pink p-l-0">
                        <li><a href="javascript:void(0);">Dashboard</a></li>
                        <li class="active">Periode</li>
                        <li class="active">Create Periode</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>Form Create Periode</h2>   <?php echo $this->session->flashdata('message'); ?>  
                    </div>
                    <div class="body">
                        <form id="form_validation" method="post" action="<?php echo base_url('index.php/periode/add_periode'); ?>">
                           <label class="form-label">ID Periode</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="id_periode" value="<?php echo $datas[0]['id_periode']; ?>" readonly>
                                </div>
                            </div>
