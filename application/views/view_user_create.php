        ...
        <div class="row">
            <div class="col-md-8 col-sm-7 col-xs-12">
                <div class="h-left clearfix">
                    <h2> USER </h2>
                    <small>Create <a href="https://datatables.net/" target="_blank">Data User</a></small>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form id="form_validation" method="post" action="<?php echo base_url('index.php/user/add_user'); ?>">
                            ...
                            <label>Pilih Level Hak Akses</label>
                            <div class="form-group">
                                <select class="form-control show-tick" name="id_level">
                                   <?php foreach ($level as $row) { ?>
                                   <option value="<?php echo $row->id_level; ?>"><?php echo $row->id_level; ?></option>
                                   <?php } ?>    
                               </select>
                           </div>
                           <button onclick="create()" class="btn btn-raised btn-success waves-effect" type="submit" value="submit">SIMPAN</button>
                       </form>
                   </div>
               </div>
           </div>
