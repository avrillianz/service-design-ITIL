        ...
        <div class="row">
            <div class="col-md-8 col-sm-7 col-xs-12">
                <div class="h-left clearfix">
                    <h2> SERVICE </h2>
                    <small>Edit <a href="https://datatables.net/" target="_blank">Data Service</a></small>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form action="<?php echo base_url('index.php/service/edit_service/'.$datas[0]['id_service']); ?>" method="post">
                            <label for="id_service">ID Service</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="id_service" class="form-control" value="<?php echo $datas[0]['id_service']; ?>" readonly>
                                </div>
                            </div>
                            <label for="service">Service</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="nama_service" class="form-control" value="<?php echo $datas[0]['nama_service']; ?>">
                                </div>
                            </div>
                            <label for="ket_service">Keterangan Service</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="ket_service" class="form-control" value="<?php echo $datas[0]['ket_service']; ?>">
                                </div>
                            </div>
                            <br>
                            <button type="submit" class="btn btn-raised btn-primary waves-effect" value="update" onclick="update()">Update</button>
                            <a href="<?php echo base_url('index.php/service'); ?>"><button class="btn btn-raised btn-warning waves-effect" type="button">KEMBALI</button>
                        </form>
                    </div>
                </div>
            </div>
